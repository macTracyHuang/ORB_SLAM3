...
def parsewifi(bagname):
    bag_path = os.getcwd() + os.path.sep + "../../p2slam/" + bagname
    save_path = os.getcwd() + os.path.sep + "fingerprint" + bagname[:-4] +".csv"
            ...
            if topic == "/wifi_fp":
                ...
                for addressRSSI in fingerprint:
                    ...
                    if bssid in unique_addr:
                        ...
                        unique_addr[bssid]=1
    print("finished parsing " + bagname)
    # print(unique_addr)
